...
conf_name='Merge_feature_512_with_as_and_cross_new_range_L2_20'
...
--gpus $gpus \
--num-nodes $node_n \
--resume /ssd1/yuju/RestoreFormer/experiments/logs/2023-10-31T22-22-22_Merge_feature_512_with_as_and_cross_new_range_L2_20/checkpoints/last.ckpt
# --random-seed True \
# --postfix $conf_name \

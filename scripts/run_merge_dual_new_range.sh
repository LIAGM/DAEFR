...
conf_name='Merge_feature_512_with_as_and_cross_dual_new_range'
...
--gpus $gpus \
--num-nodes $node_n \
--resume /ssd1/yuju/RestoreFormer/experiments/logs/2023-11-29T12-34-27_Merge_feature_512_with_as_and_cross_dual_new_range/checkpoints/last.ckpt
# --random-seed True \
# --postfix $conf_name \

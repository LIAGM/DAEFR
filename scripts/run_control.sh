...
conf_name='Merge_feature_512_with_as_and_cross_control_v2_correct'
...
--gpus $gpus \
--num-nodes $node_n \
--resume /ssd1/yuju/RestoreFormer/experiments/logs/2023-09-19T00-34-09_Merge_feature_512_with_as_and_cross_control_v2_correct/checkpoints/last.ckpt
# --random-seed True \
# --postfix $conf_name \

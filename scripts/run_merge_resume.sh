...
conf_name='Merge_feature_512_with_as_and_cross_new_range'
...
--gpus $gpus \
--num-nodes $node_n \
--resume /ssd1/yuju/RestoreFormer/experiments/logs/2023-04-25T19-02-06_Merge_feature_512_with_as_and_cross_new_range/checkpoints/last.ckpt
# --random-seed True \
# --postfix $conf_name \

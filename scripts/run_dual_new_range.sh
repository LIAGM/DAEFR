...
# conf_name='Merge_feature_512_with_as_and_cross_control_skip'
# conf_name='RestoreFormer'
# conf_name='RestoreFormer-origin'
# conf_name='RestoreFormer_code'
conf_name='Dual_codebook_new_range'
...
--gpus $gpus \
--num-nodes $node_n \
--resume /ssd1/yuju/RestoreFormer/experiments/logs/2023-10-10T22-19-13_Dual_codebook_new_range/checkpoints/last.ckpt
# --random-seed True \
# --postfix $conf_name \
